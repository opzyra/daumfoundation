...
import type { RentalAdminParamProduct } from './rentalAdminParamProduct';
import type { RentalAdminParamStatus } from './rentalAdminParamStatus';
import type { RentalDocumentDto } from './rentalDocumentDto';
import type { UserDto } from './userDto';

export interface RentalAdminParam {
  /** 대여 번호 8자리 */
  rentalNo?: number;
  /** 상태 */
  status?: RentalAdminParamStatus;
  /** 대여 희망 기간 */
  period?: number;
  /** 승인 대여 기간 */
   ...
   * @nullable
   */
  product?: RentalAdminParamProduct;
  /** 회원 PK */
  userId?: number;
  /** 회원 */
  user?: UserDto;
